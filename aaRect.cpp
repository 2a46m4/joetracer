...
XYRectangle::XYRectangle(double x0, double x1, double y0, double y1, double k, Materials *mat)
{
	this->x0 = x0;
	this->x1 = x1;
	this->y0 = y0;
...
bool XYRectangle::hit(const Ray &r, hitRecord &rec, double tMin, double tMax) const
{
	...
	if (dotProduct(r.direction, Vec(0, 0, 1)) > 0)
...
XZRectangle::XZRectangle(double x0, double x1, double z0, double z1, double k, Materials *mat)
{
	this->x0 = x0;
	this->x1 = x1;
	this->z0 = z0;
...
bool XZRectangle::hit(const Ray &r, hitRecord &rec, double tMin, double tMax) const
{
	...
	rec.t = t;
	if (dotProduct(r.direction, Vec(0, 1, 0)) > 0)
...
YZRectangle::YZRectangle(double y0, double y1, double z0, double z1, double k, Materials *mat)
{
	this->y0 = y0;
	this->y1 = y1;
	this->z0 = z0;
...
bool YZRectangle::hit(const Ray &r, hitRecord &rec, double tMin, double tMax) const
{
	...
	rec.p = hit;
	rec.t = t;
	if (dotProduct(r.direction, Vec(1, 0, 0)) > 0)

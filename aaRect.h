...
{
public:
	// The two corners that define the rectangle. also the z distance and the material
	XYRectangle(double x0, double x1, double y0, double y1, double k, Materials *mat);
...
public:
	// The two corners that define the rectangle. also the z distance and the material
	XZRectangle(double x0, double x1, double z0, double z1, double k, Materials *mat);
...
public:
	// The two corners that define the rectangle. also the z distance and the material
	YZRectangle(double y0, double y1, double z0, double z1, double k, Materials *mat);
